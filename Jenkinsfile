        ...
        stage('Deploy') {
            steps {
                withAWS(credentials: 'aws-credentials', region: 'us-east-1') {
                    ...
                    sh "aws elasticbeanstalk create-application-version --application-name mywebapp --version-label v${VERSION_NUMBER} --source-bundle S3Bucket=\"elasticbeanstalk-us-east-1-374468783315\",S3Key=\"hello-1.0.war\""
